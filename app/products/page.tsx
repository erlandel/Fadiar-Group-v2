...
export default function Products() {
  ...
  const getAllProducts = async () => {
    ...
    try {
      const token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZF91c2VyIjo4NDAsImV4cCI6MTc2Mzg3NDg0NX0.-W2-13mCQ6L7x8MQ5KQCzuhK59ZpeqAOe6Vfo7TsThk"; // tu token guardado
    ...
    <main className="flex w-full h-auto flex-col">
      <div id="main" className="flex flex-row">
        ...
        <div id="content" className="w-full mb-20  xl:w-4/5 overflow-hidden">
          ...
          <div id={"list"} className="mt-20 px-4 xl:px-0">
            ...
            <div className="flex w-full justify-between items-start mb-4">
              <div className="flex-1">
                <h2 className="text-lg md:text-xl text-primary font-bold mb-2">
          ...
          <div
            id="products"
            className="mt-20 mx-4 xl:mx-0 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:mt-0 xl:grid-cols-4 2xl:grid-cols-5 gap-4 xl:mr-15 auto-rows-fr"
          >
            {isLoading ? (
